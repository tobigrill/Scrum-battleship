...
class In_Game_UI(QWidget):
    ...
    def __init__(self):
        ...
        shoot_button.setFixedSize(160, 50)
        grid.addWidget(shoot_button, 13, 1, 1, 6)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.options_dock.setMinimumSize(700,1000)
        self.options_dock.setMaximumSize(700,1000)
        ...
        self.grid_layout.addItem(spacer, self.size+1, 2, 2, self.size) 
